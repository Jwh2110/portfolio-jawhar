    ...
    >
      ...
      <div className="fixed top-0 left-0 w-full h-full z-0 pointer-events-none">
        <div className="absolute inset-0 opacity-40">
          ...
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-gradient-to-br from-[#ff006e] to-[#00d4ff] rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-bounce-crazy" />
          <div className="absolute -bottom-8 left-1/2 w-96 h-96 bg-gradient-to-br from-[#00ff88] to-[#ff006e] rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-spin-wild" />
