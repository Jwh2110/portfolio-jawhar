          ...
          <nav className="hidden md:flex items-center gap-12">
            {navItems.map((item, i) => (
              <motion.a
                ...
                className="text-sm font-medium text-gray-400 hover:text-[#d4af37] transition-colors relative group"
              >
                {item}
          ...
          >
            {navItems.map((item, i) => (
              <motion.a
                ...
                className="block px-4 py-2 text-gray-400 hover:text-[#d4af37] transition-colors"
                whileHover={{ x: 10 }}
              >
                {item}
              </motion.a>
